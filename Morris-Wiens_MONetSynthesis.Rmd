...
```{r Rs Analysis, fig.dim=c(6,6), fig.align='center'}
...
![Spatial Comparison of MONet and SoilGrids](./figures/MONet_sg_clay_map.png)

Spatially MONet shows promise at representing the distribution of clay content in CONUS.
