...
# 1. Examining Soil Respiration relative to Mean Annual Precipitation
...
## Extract Mean Annual Precipitation (MAP) and Mean Annual Temperature
## (MAT) for sample coordinates
...
The following figure show the relationship of MONet data points and
...
was generally within the spread of the of the 25th and 75th confidence
...
This analysis identified 6 MONet sample sites in locations with
...
soil health and processes in urban environments. The 6 locations were
made up of 3 site in College Park, MD, 2 in Baltimore, MD, and 1 in
Philadelphia, PA:
...
MONetDataPrepocessing.R. There was so much more to explore than could be
