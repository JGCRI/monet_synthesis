...
monet_pH_coord <- read.csv("data/pH/processed_data/Coordinates.csv")
monet_clay_coord <- read.csv("data/clay/processed_data/Coordinates.csv")

# read in site data
monet_pH_data <- read.csv("data/pH/processed_data/Soil_BioChemical_properties.csv")
monet_clay_data <- read.csv("data/clay/processed_data/Soil_BioChemical_properties.csv")
...
climate_zones_sf <- st_read("data/na_climatezones_shapefile/climatezones_shapefile/NA_ClimateZones/data/North_America_Climate_Zones.shp")
...
CONUS_sf <- st_read("data/s_18mr25/s_18mr25.shp")%>%
