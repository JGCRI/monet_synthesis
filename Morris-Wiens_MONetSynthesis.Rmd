...
sg_mini_clay_top_prj <- terra::rast("R_data/sg_mini_clay_top_prj.tif") 

#To DO: replace/overlay site codes with sample counts
ggplot()+
  tidyterra::geom_spatraster(data = sg_mini_clay_top_prj)+
...
# or is it not possible to read it in from .Rdata without errors?
